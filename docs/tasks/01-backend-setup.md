...
- [x] Add Tauri plugins: `tauri-plugin-deep-link`, `tauri-plugin-notification`, `tauri-plugin-updater`, `tauri-plugin-log`
...
- [ ] Create Tauri command scaffold with error handling pattern using `thiserror` crate
...
- [ ] Verify build compiles on macOS with `pnpm tauri dev`
